...
const Checkout = () => {
  ...
  const { cartItems, total, sendOrder, reduceStock, orderId } = useContext(CartContext)
  ...
  const emailValidation = () => {
    ...
    let secondEmail = document.getElementsByName('email-confirmation')
      ...
      {cartItems.length > 0 ? (
        ...
        <div className="checkout-left">
          ...
          <form>
            ...
            <input type="email" name="email-confirmation" placeholder="Confirme su Email*" required />
